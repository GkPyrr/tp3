...
void deplacement::avance(gen::map<char>& carte, entity& who) {
...
bool deplacement::canAdvance(gen::map<char>& carte, const int& y, const int& x, const char& direction, char cas) {
