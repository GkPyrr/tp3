...
public:
	...
	void avance(gen::map<char>& carte, entity & who);						// va essayer d'avancer
	bool canAdvance(gen::map<char>& carte, const int& y, const int& x, const char& direction, char cas);		// check si peu avancer
};
